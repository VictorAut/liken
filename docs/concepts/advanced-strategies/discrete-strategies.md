...
|-------------| ------------- | ----------------------------------------------------- | ---------------------------------------------------------------- |
| *Continuous* |*single-column*| [`exact`](../../reference/enlace/#enlace.exact)       | You've already seen this in use *implicitely* in your [First Steps](../concepts/first-steps.md)  |
...
| *Discrete* |*single-column*| [`lsh`](../../reference/rules/#enlace.rules.str_len)              | Records where the string length is bounded by a minimum and maximum length           |
