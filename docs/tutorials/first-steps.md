...
??? question "Not a Pandas user?"
    Not to worry, **Enlace** supports [multiple backends](../tutorials/supported-backends.md).
...
!!! note "Talk about 'handy'..."
    **Enlace** provides synthesised data in the [`datasets` package](../tutorials/using-synthetic-data.md). Now and then you may notice we're making reference to it's *handiest* dataset, [`fake_10`](../../reference/datasets/#enlace.datasets.fake_10).
